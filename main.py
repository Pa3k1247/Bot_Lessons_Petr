...
<b>Важный момент:</b> чтобы полноценно пройти практическую часть и закрепить материал, потребуется тестовый доступ к боту <b>@Lime_AI_bot</b>
...
крутой контент в @Lime_AI_bot</b>💡"""
        try:
